...
def lambda_handler(event, context):
    ...
    table_name_final_mysql = dict_cfg["tables"][target_table_to_load]["final_name"]
    ...
    try:
        print("Deleting matching records from final table.")
        query = f"""DELETE FROM {table_name_final_mysql} WHERE admw_origin_file_name=%s;"""
        task = (file_name)
